...
router.put("/api/cart/affordable/update/:userId/:productId/:quantity", auth, cartController.updateQuantity);
router.delete("/api/cart/affordable/remove/:userId/:productId", auth, cartController.removeItem);
